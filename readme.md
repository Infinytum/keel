...
This is a modified version of keel, providing init container support and some repairs for the GitHub Webhook endpoint. You can open a GitHub issue if it breaks but:
...
- **Notifications** - out of the box Keel has Slack, Hipchat, Mattermost and standard webhook notifications, more info [here](https://keel.sh/docs/#notifications)
